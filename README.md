...
**Tech Stack:** AWS Kinesis, Lambda, S3, Glue, Athena, SNS, QuickSight

- Processed real-time patient data streams
- Built anomaly detection and alerting pipelines
- Created cloud analytics dashboards

### 🏫 CPByte Student Portal

**Tech Stack:** React, Vite, Tailwind CSS, Redux, Material UI

- Built a centralized portal for student activities
